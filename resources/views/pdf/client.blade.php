...
<body>
    <p style="text-align: left; margin-bottom: 18pt">
        <img src="{{public_path('images/logo.png')}}" style="width: 200px;" alt=""> <br>
        <strong style="font-size: 16pt">Resona Banking, Inc.</strong> <br> 
        #445 Ill Fortune St., Merrycormic <br>
        Japan <br>
        Tel. No.: 555-666-7890, 223-129-9089
    </p>

    <h1>Resona Bank Summary</h1>
